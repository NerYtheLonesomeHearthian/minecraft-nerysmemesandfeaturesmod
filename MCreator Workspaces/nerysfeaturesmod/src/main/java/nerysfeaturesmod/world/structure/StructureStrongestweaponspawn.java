...
public class StructureStrongestweaponspawn extends ElementsNerYsFeaturesMod.ModElement {
	public StructureStrongestweaponspawn(ElementsNerYsFeaturesMod instance) {
		super(instance, 227);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nerysfeaturesmod", "strongestweapon"));
				if (template == null)
					return;
