...
public class StructureOldtower extends ElementsNerYsFeaturesMod.ModElement {
	public StructureOldtower(ElementsNerYsFeaturesMod instance) {
		super(instance, 54);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nerysfeaturesmod", "oldtower"));
				if (template == null)
					return;
