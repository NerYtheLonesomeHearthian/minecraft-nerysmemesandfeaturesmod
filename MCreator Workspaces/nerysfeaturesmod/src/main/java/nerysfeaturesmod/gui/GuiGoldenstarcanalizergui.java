...
import nerysfeaturesmod.procedure.ProcedureProcedureforgoldenstarcanalizergui;
...
public class GuiGoldenstarcanalizergui extends ElementsNerYsFeaturesMod.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiGoldenstarcanalizergui(ElementsNerYsFeaturesMod instance) {
		super(instance, 174);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 26, 41) {
				@Override
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemIncavedgoldsword.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 41) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nerysfeaturesmod:textures/goldenstarcanalizergui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Canalize Star Cluster in ", 25, 4, -1);
			this.fontRenderer.drawString("Incaved Golden Sword", 34, 16, -1);
		}
		...
		if (slotID == 0 && changeType == 1) {
			{
				...
				ProcedureProcedureforgoldenstarcanalizergui.executeProcedure($_dependencies);
			}
		}
	}
}
