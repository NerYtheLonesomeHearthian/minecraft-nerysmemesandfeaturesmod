...
import nerysfeaturesmod.procedure.ProcedureProcedureforhammerincaver;

import nerysfeaturesmod.item.ItemHammer;
...
public class GuiGuiforhammerincaver extends ElementsNerYsFeaturesMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiGuiforhammerincaver(ElementsNerYsFeaturesMod instance) {
		super(instance, 245);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 26, 35) {
				@Override
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemHammer.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 35) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nerysfeaturesmod:textures/guiforhammerincaver.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Hammer Incaver", 56, 6, -1);
			this.fontRenderer.drawString("Put and take", 4, 52, -16776961);
			this.fontRenderer.drawString("back Hammer here", 4, 64, -16776961);
		}
		...
		if (slotID == 0 && changeType == 1) {
			{
				...
				ProcedureProcedureforhammerincaver.executeProcedure($_dependencies);
			}
		}
	}
}
