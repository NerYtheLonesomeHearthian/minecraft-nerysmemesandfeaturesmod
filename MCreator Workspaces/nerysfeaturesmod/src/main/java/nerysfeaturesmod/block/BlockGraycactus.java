...
public class BlockGraycactus extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:gray_cactus")
	public static final Block block = null;
	public BlockGraycactus(ElementsNerYsFeaturesMod instance) {
		super(instance, 273);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:gray_cactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("gray_cactus");
			setRegistryName("gray_cactus");
		}
