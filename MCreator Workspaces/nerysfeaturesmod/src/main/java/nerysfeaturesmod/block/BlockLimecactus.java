...
public class BlockLimecactus extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:lime_cactus")
	public static final Block block = null;
	public BlockLimecactus(ElementsNerYsFeaturesMod instance) {
		super(instance, 267);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:lime_cactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("lime_cactus");
			setRegistryName("lime_cactus");
		}
