...
public class BlockPinkcactus extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:pink_cactus")
	public static final Block block = null;
	public BlockPinkcactus(ElementsNerYsFeaturesMod instance) {
		super(instance, 271);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:pink_cactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("pink_cactus");
			setRegistryName("pink_cactus");
		}
