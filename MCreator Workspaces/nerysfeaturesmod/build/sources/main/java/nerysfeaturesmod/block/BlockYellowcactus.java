...
public class BlockYellowcactus extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:yellow_cactus")
	public static final Block block = null;
	public BlockYellowcactus(ElementsNerYsFeaturesMod instance) {
		super(instance, 281);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:yellow_cactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("yellow_cactus");
			setRegistryName("yellow_cactus");
		}
