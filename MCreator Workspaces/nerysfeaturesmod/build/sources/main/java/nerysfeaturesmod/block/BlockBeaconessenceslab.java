...
public class BlockBeaconessenceslab extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:beacon_essence_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("nerysfeaturesmod:beacon_essence_slab_double")
	public static final Block block_slab_double = null;
	public BlockBeaconessenceslab(ElementsNerYsFeaturesMod instance) {
		super(instance, 256);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("beacon_essence_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("beacon_essence_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:beacon_essence_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("beacon_essence_slab");
