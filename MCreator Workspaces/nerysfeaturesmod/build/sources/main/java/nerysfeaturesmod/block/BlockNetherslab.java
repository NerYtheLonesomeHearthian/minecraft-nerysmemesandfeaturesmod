...
public class BlockNetherslab extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:nether_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("nerysfeaturesmod:nether_slab_double")
	public static final Block block_slab_double = null;
	public BlockNetherslab(ElementsNerYsFeaturesMod instance) {
		super(instance, 322);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nether_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("nether_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:nether_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("nether_slab");
