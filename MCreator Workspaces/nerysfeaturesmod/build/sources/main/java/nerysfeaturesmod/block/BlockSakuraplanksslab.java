...
public class BlockSakuraplanksslab extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:sakura_wood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("nerysfeaturesmod:sakura_wood_slab_double")
	public static final Block block_slab_double = null;
	public BlockSakuraplanksslab(ElementsNerYsFeaturesMod instance) {
		super(instance, 202);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sakura_wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sakura_wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:sakura_wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("sakura_wood_slab");
