...
public class BlockBasaltsideslab extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:basalt_side_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("nerysfeaturesmod:basalt_side_slab_double")
	public static final Block block_slab_double = null;
	public BlockBasaltsideslab(ElementsNerYsFeaturesMod instance) {
		super(instance, 309);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("basalt_side_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("basalt_side_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:basalt_side_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("basalt_side_slab");
