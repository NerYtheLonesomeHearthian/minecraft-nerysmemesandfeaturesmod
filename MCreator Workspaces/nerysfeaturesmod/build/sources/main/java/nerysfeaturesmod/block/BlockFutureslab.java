...
public class BlockFutureslab extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:future_wood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("nerysfeaturesmod:future_wood_slab_double")
	public static final Block block_slab_double = null;
	public BlockFutureslab(ElementsNerYsFeaturesMod instance) {
		super(instance, 218);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("future_wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("future_wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:future_wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("future_wood_slab");
