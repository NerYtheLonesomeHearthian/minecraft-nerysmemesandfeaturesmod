...
public class BlockLightbluecactus extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:light_blue_cactus")
	public static final Block block = null;
	public BlockLightbluecactus(ElementsNerYsFeaturesMod instance) {
		super(instance, 277);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:light_blue_cactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("light_blue_cactus");
			setRegistryName("light_blue_cactus");
		}
