...
public class BlockLightgraycactus extends ElementsNerYsFeaturesMod.ModElement {
	@GameRegistry.ObjectHolder("nerysfeaturesmod:light_gray_cactus")
	public static final Block block = null;
	public BlockLightgraycactus(ElementsNerYsFeaturesMod instance) {
		super(instance, 275);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nerysfeaturesmod:light_gray_cactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("light_gray_cactus");
			setRegistryName("light_gray_cactus");
		}
