...
public class StructureSpawnfuturetree extends ElementsNerYsFeaturesMod.ModElement {
	public StructureSpawnfuturetree(ElementsNerYsFeaturesMod instance) {
		super(instance, 88);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 999999) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nerysfeaturesmod", "future_tree"));
				if (template == null)
					return;
