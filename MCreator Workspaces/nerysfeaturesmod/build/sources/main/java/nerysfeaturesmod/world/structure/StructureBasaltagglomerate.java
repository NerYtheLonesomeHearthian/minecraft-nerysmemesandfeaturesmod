...
public class StructureBasaltagglomerate extends ElementsNerYsFeaturesMod.ModElement {
	public StructureBasaltagglomerate(ElementsNerYsFeaturesMod instance) {
		super(instance, 304);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nerysfeaturesmod", "basalt_agglomerate"));
				if (template == null)
					return;
