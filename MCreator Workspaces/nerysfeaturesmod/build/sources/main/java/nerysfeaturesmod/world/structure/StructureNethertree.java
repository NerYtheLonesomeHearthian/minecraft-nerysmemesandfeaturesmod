...
public class StructureNethertree extends ElementsNerYsFeaturesMod.ModElement {
	public StructureNethertree(ElementsNerYsFeaturesMod instance) {
		super(instance, 305);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 500000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nerysfeaturesmod", "nether_tree"));
				if (template == null)
					return;
